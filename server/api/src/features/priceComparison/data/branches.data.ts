...
export const BRANCHES: BranchSeed[] = [
  ...
  { chainId: 'rami_levy', branchName: 'רמי לוי שער בנימין', city: 'שער בנימין', address: 'אזור התעשייה שער בנימין', lat: 31.8773, lng: 35.2623 },
  { chainId: 'rami_levy', branchName: 'רמי לוי פסגות', city: 'פסגות', address: 'בנימין', lat: 31.9005, lng: 35.2770 },
  { chainId: 'rami_levy', branchName: 'רמי לוי עטרות', city: 'ירושלים', address: 'אזור התעשייה עטרות', lat: 31.8607, lng: 35.2213 },
  { chainId: 'rami_levy', branchName: 'רמי לוי נחליאל', city: 'נחליאל', address: 'בנימין', lat: 31.9790, lng: 35.1230 },
