...
export const ru: Translations = {
  ...
  subscriptionCancelBtn: 'Отменить подписку',
  subscriptionCancelTitle: 'Отмена подписки Pro',
  subscriptionCancelDesc: 'Отмена вернёт вас на бесплатный план с ограничениями. Ваши данные сохранятся.',
