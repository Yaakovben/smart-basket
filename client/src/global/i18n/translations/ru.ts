...
export const ru: Translations = {
  ...
  tipShareQrTitle: 'Приглашение по сканированию',
  tipShareQrBody: 'На экране приглашения есть QR-код — по нему сразу присоединяются к списку, без ввода кода и пароля.',
  tipMoveProductsTitle: 'Перенос между списками',
  tipMoveProductsBody: 'Долгое нажатие на товар включает выбор — отметьте несколько и выберите «Перенести в список», чтобы перенести все сразу.',
  tipLongPressTitle: 'Множественный выбор',
  tipLongPressBody: 'Долгое нажатие на товар включает режим выбора. Отметьте несколько и удалите / отметьте купленными / перенесите — всё вместе.',
  tipSwipeTitle: 'Свайп для быстрых действий',
  tipSwipeBody: 'Проведите по строке товара влево, чтобы открыть быстрые действия: удалить, отметить купленным, изменить.',
  ...
  tipInsightsTitle: 'Аналитика и расходы',
  tipInsightsBody: 'Вкладка «Аналитика» показывает, сколько вы потратили за месяц и на что, прогноз до конца месяца и сравнение цен по сетям.',
};
