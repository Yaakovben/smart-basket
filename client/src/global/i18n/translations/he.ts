...
export const he: Translations = {
  ...
  tipEyebrow: 'טיפ',
  tipGotIt: 'הבנתי',
  tipScanListTitle: 'סרוק רשימה מצילום',
  tipScanListBody: 'יש לך פתק או רשימה כתובה? צלם אותה מתפריט "עוד" ← "סרוק רשימה", והמוצרים ייכנסו אוטומטית.',
  tipProductPhotoTitle: 'תמונה למוצר',
  tipProductPhotoBody: 'בהוספת/עריכת מוצר אפשר לצרף תמונה — כך כל מי שקונה יודע בדיוק איזה מותג ואיזו אריזה.',
  tipShareQrTitle: 'הזמנה בסריקה מהירה',
  tipShareQrBody: 'במסך ההזמנה יש קוד QR — מי שסורק אותו מצטרף לרשימה מיד, בלי להקליד קוד וסיסמה.',
  tipMoveProductsTitle: 'העברה בין רשימות',
  tipMoveProductsBody: 'לחיצה ארוכה על מוצר פותחת בחירה — סמן כמה, ובחר "העבר לרשימה" כדי להעביר את כולם בבת אחת.',
  tipLongPressTitle: 'בחירה מרובה',
  tipLongPressBody: 'לחיצה ארוכה על מוצר מפעילה מצב בחירה. סמן כמה מוצרים ומחק / סמן כנקנו / העבר — הכל יחד.',
  tipSwipeTitle: 'החלקה לפעולות מהירות',
  tipSwipeBody: 'החלק מוצר שמאלה בשורה כדי לחשוף פעולות מהירות: מחיקה, סימון כנקנה, ועריכה.',
  tipSavedListsTitle: 'רשימות קבועות',
  tipSavedListsBody: 'קניות שחוזרות כל שבוע? שמור אותן כרשימה קבועה, והוסף את כל המוצרים בלחיצה אחת בכל פעם.',
  tipInsightsTitle: 'תובנות והוצאות',
  tipInsightsBody: 'בטאב "תובנות" רואים כמה הוצאת החודש ועל מה, צפי לסוף החודש, והשוואת מחירים בין הרשתות.',
};
