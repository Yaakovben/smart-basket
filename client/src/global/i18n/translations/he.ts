...
export const he: Translations = {
  ...
  newSavedList: 'רשימה קבועה חדשה',
  noSavedListsYet: 'עדיין אין רשימות קבועות',
  noSavedListsDesc: 'שמור רשימה שאתה קונה שוב ושוב - והוסף אותה לכל רשימה בלחיצה אחת',
