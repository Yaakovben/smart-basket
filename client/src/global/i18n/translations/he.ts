...
export const he: Translations = {
  ...
  subscriptionCancelBtn: 'בטל מנוי',
  subscriptionCancelTitle: 'ביטול מנוי Pro',
  subscriptionCancelDesc: 'ביטול המנוי יחזיר אותך לתוכנית החינמית עם מגבלות. הנתונים שלך יישמרו.',
