...
export const he: Translations = {
  ...
  tipPriceComparisonBody: 'בטאב "השוואת מחירים" רואים איפה הרשימה שלך הכי זולה, מוצר-מוצר, בין כל הרשתות הגדולות.',
  tipShareWhatsappTitle: 'שיתוף מהיר בוואטסאפ',
  tipShareWhatsappBody: 'מתפריט השיתוף אפשר לשלוח את הרשימה כהודעת וואטסאפ מסודרת, בלחיצה אחת.',
  tipSharePdfTitle: 'הרשימה כקובץ PDF',
  tipSharePdfBody: 'מתפריט השיתוף יש גם "שתף כ-PDF" — מייצא את הרשימה כקובץ מסודר להדפסה או שמירה.',
  ...
  tipMuteListBody: 'רשימה קבוצתית רועשת מדי? מתפריט הרשימה אפשר "השתק רשימה" — היא תישאר פעילה, רק בלי להתריע.',
};
