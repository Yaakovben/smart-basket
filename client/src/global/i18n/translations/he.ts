...
export const he: Translations = {
  ...
  permanentList: 'רשימה קבועה',
  permanentListHint: 'ניקוי הרשימה יאפס את המוצרים במקום למחוק אותם',
  permanentListClearHint: 'זו רשימה קבועה - מומלץ להשתמש באיפוס כדי שהמוצרים יהיו מוכנים לפעם הבאה',
  clearList: 'נקה רשימה',
  clearAll: 'מחק הכל',
