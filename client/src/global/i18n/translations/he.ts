...
export const he: Translations = {
  ...
  feedbackPlaceholder: 'מה אפשר לייעל? מה היית רוצה שיהיה?',
  feedbackSend: 'שליחה',
  feedbackMaybeLater: 'אולי אחר כך',
  feedbackThanks: 'תודה על המשוב!',
  feedbackRatingPrompt: 'דרגו את החוויה שלכם',
  feedbackRatingAria: 'דירוג חוויית משתמש',
  feedbackRating1: 'לא טוב',
  feedbackRating2: 'סביר',
  feedbackRating3: 'טוב',
  feedbackRating4: 'טוב מאוד',
  feedbackRating5: 'מעולה!',
  // About
  ...
  closeModalAria: 'סגור',
  qrPasswordMissing: 'הקוד זוהה אך הסיסמה חסרה או לא תקפה — הזינו סיסמה ידנית.',
  qrNotGroupCode: 'זה לא QR להצטרפות לקבוצה — סרקו את ה-QR שקיבלתם מהמזמין.',
  recentlyAdded: 'הוספו לאחרונה',
  betaBadgeLabel: 'גרסת בטא',
  retry: 'נסה שוב',
  ...
  photoSyncFailed: 'התמונה נשמרה במכשיר, אך לא הועלתה לענן.',
  photoRetryUpload: 'נסו להעלות שוב',
  photoSavedToCloud: 'התמונה נשמרה',
  photoDropHint: 'שחררו כאן כדי להוסיף תמונה',
  ...
  priceHelpTitle: 'איך זה עובד?',
  priceHelpIntro: 'כמה טיפים קצרים להשוואת מחירים מדויקת יותר, בשליטתך.',
  priceHelpBranchTitle: 'בחירת סניף',
  priceHelpBranchDesc: 'בכל כרטיס רשת יש כפתור "החלף סניף" - אפשר לחפש ולבחור סניף ספציפי במקום הקרוב אליך אוטומטית. המחירים יתעדכנו לפי הסניף שבחרת.',
  priceHelpMatchTitle: 'תיקון התאמת מוצר',
  priceHelpMatchDesc: 'אם מוצר זוהה לא נכון (או בכלל לא זוהה), לחץ "לא המוצר הנכון?" ליד השורה שלו וחפש את המוצר המדויק. אפשר גם לסמן "אף אחד מאלה" אם הוא לא קיים ברשת. הבחירה נשמרת לפעם הבאה.',
  priceHelpVerifiedTitle: 'מחיר מאומת מול הערכה',
  priceHelpVerifiedDesc: 'סימון ירוק ליד המחיר אומר שהוא אומת בסניף עצמו. בלי סימון - זו הערכה לפי המחיר הנפוץ ברשת, ויכולה להיות מעט שונה בפועל.',
  ...
  cheaperAtBranch: 'זול יותר (₪{price}) בסניף {branch}',
  ...
  changeBranch: 'החלף סניף',
  chooseBranchTitle: 'בחירת סניף ל{chain}',
  useNearestBranch: 'הסניף הקרוב אליי',
  branchChosenByYou: 'נבחר על ידך',
  branchHasNoPriceData: 'אין נתוני מחיר לסניף',
  branchPricesVerified: '{n} מתוך {m} מחירים מאומתים בסניף',
  staleChainData: 'נתונים מלפני {days} ימים',
  lowConfidenceMatch: 'בדוק שזה המוצר הנכון',
  splitSavingsHint: 'פיצול קניות בין רשתות יחסוך עוד {amount}',
  matchPickerTitle: 'איזה מוצר התכוונת?',
  matchPickerSubtitle: 'הבחירה נשמרת ותחול על כל הרשתות והרשימות',
  matchPickerSearchPlaceholder: 'חפש מוצר',
  matchPickerNoResults: 'לא נמצאו מוצרים. נסה מילה אחרת',
  matchPickerInChains: 'ב-{count} רשתות',
  matchPickerFrom: 'מ-',
  matchPickerNoneOfThese: 'אף אחד מאלה',
  matchPickerReset: 'חזרה להתאמה אוטומטית',
  matchPickerSaveFailed: 'השמירה נכשלה, נסה שוב',
  matchFixAction: 'חפש ידנית',
  matchNotRightAction: 'לא המוצר הנכון?',
  ...
  noPendingItemsInList: 'אין מוצרים שטרם נקנו ברשימה',
  ...
  noMatchInListHint: 'לא הצלחנו לזהות אף מוצר מהרשימה במאגר.',
  ...
  cacheNoticeTitle: 'עדכנו את האפליקציה',
  cacheNoticeBody: 'בעקבות שדרוגים אחרונים, ייתכן שהאפליקציה תיתקע על "מתחבר לשרת" או שפעולות לא יעבדו. אם זה קורה - לחצו כאן לאיפוס מהיר וחד-פעמי (לא תנותקו).',
  cacheNoticeCta: 'איפוס מהיר',
  cacheNoticeDismiss: 'לא קורה לי, תודה',
  ...
  tipEyebrow: 'ידעת ש...?',
  tipGotIt: 'מעולה, הבנתי!',
  tipNext: 'הבא',
  tipDotAria: 'טיפ {num}',
  tipDontShowAgain: 'אל תציגו לי את זה שוב',
  tipScanListTitle: 'צילום אחד, רשימה שלמה',
  tipScanListBody: 'יש פתק או רשימה כתובה ביד? תפריט "עוד" ← "סרוק רשימה" - והמוצרים נכנסים אוטומטית, בלי להקליד מילה.',
  tipProductPhotoTitle: 'כל מוצר עם תמונה משלו',
  tipProductPhotoBody: 'בהוספה או עריכה של מוצר אפשר לצרף תמונה - כך מי שיוצא לקנות מזהה מהמדף במבט אחד, בלי ניחושים.',
  tipProductNoteTitle: 'הערה קטנה, הבדל גדול',
  tipProductNoteBody: 'מותג מועדף, גודל אריזה, או כל פרט שכדאי שמי שקונה יידע - אפשר לצרף כהערה קצרה לכל מוצר.',
  tipProductReorderTitle: 'הרשימה, בסדר שלכם',
  tipProductReorderBody: 'בכפתור "סידור מוצרים" גוררים כל מוצר למקום שנוח - למשל בדיוק לפי סדר המעברים בסופר שלכם.',
  tipListReorderTitle: 'הרשימות שלכם, כמו שנוח לכם',
  tipListReorderBody: 'במסך הבית, כפתור "סידור רשימות" מאפשר לגרור כרטיס למיקום אחר ולסדר הכל בול כמו שנוח לכם.',
  tipAiAssistantTitle: 'עוזר קניות שמכיר אתכם',
  tipAiAssistantBody: 'לוחצים על כפתור ה-AI ✨ ושואלים על סופרים ומחירים - התשובות מבוססות על ההוצאות וההרגלים האמיתיים שלכם.',
  tipPriceComparisonTitle: 'איפה זה יוצא הכי זול?',
  tipPriceComparisonBody: 'בטאב "השוואת מחירים" רואים מוצר-מוצר איפה הרשימה שלכם הכי משתלמת, מול כל הרשתות הגדולות.',
  tipShareWhatsappTitle: 'שיתוף מהיר בוואטסאפ',
  tipShareWhatsappBody: 'מתפריט השיתוף שולחים את הרשימה כהודעת וואטסאפ מסודרת - בלחיצה אחת.',
  tipSharePdfTitle: 'הרשימה כקובץ PDF',
  tipSharePdfBody: 'מתפריט השיתוף יש גם "שתף כ-PDF" - קובץ מסודר, מוכן להדפסה או לשמירה.',
  tipSavedListsTitle: 'רשימות קבועות',
  ...
  tipDragFabTitle: 'אפשר לגרור את כפתור ההוספה',
  ...
  subscriptionCancelTitle: 'ביטול חידוש אוטומטי',
  ...
  upgradeBestValueBadge: 'הכי משתלם',
  perMonthShort: 'חודש',
};
