...
export const en: Translations = {
  ...
  permanentList: 'Permanent list',
  permanentListHint: 'Clearing this list will reset items instead of deleting them',
  permanentListClearHint: 'This is a permanent list - use Reset to keep items ready for next time',
