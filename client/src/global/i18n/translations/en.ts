...
export const en: Translations = {
  ...
  feedbackPlaceholder: 'What could be improved? What would you like to see?',
  feedbackSend: 'Send',
  feedbackMaybeLater: 'Maybe later',
  feedbackThanks: 'Thanks for the feedback!',
  feedbackRatingPrompt: 'Rate your experience',
  feedbackRatingAria: 'User experience rating',
  feedbackRating1: 'Not good',
  feedbackRating2: 'Okay',
  ...
  weekdayFridayPrep: 'Getting ready for Shabbat? 🕯️',
  weekdaySaturdayNight: 'New week 💪',
  weekdaySundayMorning: 'New week starting 🚀',
  search: 'Search...',
  ...
  qrPasswordMissing: 'Code detected but password is missing or invalid — enter the password manually.',
  qrNotGroupCode: 'This is not a group invite QR code — scan the QR you received from the host.',
  recentlyAdded: 'Recently added',
  betaBadgeLabel: 'Beta version',
  retry: 'Try again',
  ...
  photoSyncFailed: 'The photo is saved on this device, but wasn\'t uploaded to the cloud.',
  photoRetryUpload: 'Retry upload',
  photoSavedToCloud: 'Photo saved',
  photoDropHint: 'Drop here to add a photo',
  ...
  priceHelpTitle: 'How does this work?',
  priceHelpIntro: 'A few short tips to make the price comparison more accurate, in your control.',
  priceHelpBranchTitle: 'Choosing a branch',
  priceHelpBranchDesc: 'Every chain card has a "Change branch" button - search and pick a specific branch instead of the one picked automatically by distance. Prices update to match the branch you chose.',
  priceHelpMatchTitle: 'Fixing a product match',
  priceHelpMatchDesc: 'If a product was matched wrong (or not matched at all), tap "Not the right product?" next to its row and search for the exact one. You can also mark "None of these" if it is not sold there. The choice is remembered next time.',
  priceHelpVerifiedTitle: 'Verified price vs. estimate',
  priceHelpVerifiedDesc: 'A green mark next to the price means it was verified at that specific branch. Without it, the price is an estimate based on the chain\'s typical price, and may differ slightly in the store.',
  ...
  cheaperAtBranch: 'Cheaper (₪{price}) at {branch}',
  ...
  chooseBranchTitle: 'Choose a {chain} branch',
  useNearestBranch: 'Nearest branch to me',
  branchChosenByYou: 'Chosen by you',
  branchHasNoPriceData: 'No price data for this branch',
  branchPricesVerified: '{n} of {m} prices verified at this branch',
  staleChainData: 'Data from {days} days ago',
  lowConfidenceMatch: 'Check this is the right product',
  splitSavingsHint: 'Splitting your shop across chains saves {amount} more',
  matchPickerTitle: 'Which product did you mean?',
  matchPickerSubtitle: 'Your choice is saved and applies to all chains and lists',
  matchPickerSearchPlaceholder: 'Search a product',
  matchPickerNoResults: 'No products found. Try another word',
  matchPickerInChains: 'in {count} chains',
  matchPickerFrom: 'from',
  matchPickerNoneOfThese: 'None of these',
  matchPickerReset: 'Back to automatic match',
  matchPickerSaveFailed: 'Saving failed, try again',
  matchFixAction: 'Search manually',
  matchNotRightAction: 'Not the right product?',
  matchChosenByYou: 'Product chosen by you',
  ...
  noPendingItemsInList: 'No unpurchased products in the list',
  ...
  noMatchInListHint: 'We couldn\'t identify any products from the list in the database.',
  ...
  selectedOfCount: 'of {total}',
  itemHasNote: 'This item has a note',
  longPressMultiSelectHint: 'Tip: Long-press an item to select multiple',
  dismissHint: 'Dismiss tip',
  aiAndInsights: 'AI & insights',
  listAnalysisTitle: 'List analysis',
  analyzingList: 'Analyzing the list...',
  noAnalysisThisTime: 'No text analysis came back this time - try again later. The price estimate below is still accurate.',
  estimatedBasketCost: 'Estimated basket cost',
  itemsIdentifiedOfTotal: '{matched} of {total} items identified',
  priceComparisonShort: 'Price comparison',
  tellMeMoreAboutList: 'Tell me more about the "{name}" list and how to improve it',
  ...
  savedListNameExample: 'e.g. Weekly groceries',
  chooseIcon: 'Choose an icon',
  savedListSaved: 'Saved list stored',
  savedListApplied: 'items added',
  savedListAllPresent: 'All items are already in the list',
  ...
  savedListsChooserCreateDisabledDesc: 'Add products to the list before saving it',
  ...
  cacheNoticeTitle: 'We updated the app',
  cacheNoticeBody: 'After recent upgrades, the app might get stuck on "connecting to server" or actions might fail. If that happens - tap here for a quick, one-time reset (you won\'t be logged out).',
  cacheNoticeCta: 'Quick reset',
  cacheNoticeDismiss: 'Not happening to me, thanks',
  ...
  tipEyebrow: 'Did you know?',
  tipGotIt: 'Great, got it!',
  tipNext: 'Next',
  tipDotAria: 'Tip {num}',
  tipDontShowAgain: "Don't show this again",
  tipScanListTitle: 'Scan a list from a photo',
  tipScanListBody: 'Got a handwritten list? Snap it from the "More" menu → "Scan list" and the items get added automatically.',
  tipProductPhotoTitle: 'Add a product photo',
  tipProductPhotoBody: 'When adding or editing a product you can attach a photo — so whoever shops knows the exact brand and package.',
  tipProductNoteTitle: 'Add a note',
  tipProductNoteBody: 'When adding or editing a product you can write a short note — preferred brand, size, or any detail worth knowing.',
  tipProductReorderTitle: 'Arrange your products',
  tipProductReorderBody: 'The "Sort products" button lets you drag each item wherever suits you — say, in the exact order you walk the store.',
  tipListReorderTitle: 'Arrange your lists',
  tipListReorderBody: 'On the home screen, "Sort lists" lets you drag a list card to a new spot and arrange everything exactly how you like.',
  tipAiAssistantTitle: 'Smart shopping assistant',
  tipAiAssistantBody: 'The AI ✨ button lets you ask about stores and prices, and get recommendations based on your real spending and habits.',
  tipPriceComparisonTitle: 'Compare prices across chains',
  tipPriceComparisonBody: 'The "Price comparison" tab shows where your list is cheapest, item by item, across all the major chains.',
  tipShareWhatsappTitle: 'Quick share on WhatsApp',
  tipShareWhatsappBody: 'The share menu lets you send the list as a tidy WhatsApp message, in one tap.',
  tipSharePdfTitle: 'Your list as a PDF',
  tipSharePdfBody: 'The share menu also has "Share as PDF" — exports the list as a tidy file to print or save.',
  tipSavedListsTitle: 'Saved lists',
  ...
  upgradeBestValueBadge: 'Best value',
  perMonthShort: 'month',
};
