...
export const en: Translations = {
  ...
  tipShareQrTitle: 'Invite with a quick scan',
  tipShareQrBody: 'The invite screen has a QR code — scanning it joins the list instantly, no code or password to type.',
  tipMoveProductsTitle: 'Move between lists',
  tipMoveProductsBody: 'Long-press a product to start selecting — pick a few, then choose "Move to list" to move them all at once.',
  tipLongPressTitle: 'Multi-select',
  tipLongPressBody: 'Long-press a product to enter selection mode. Mark several and delete / mark bought / move — all together.',
  tipSwipeTitle: 'Swipe for quick actions',
  tipSwipeBody: 'Swipe a product row left to reveal quick actions: delete, mark as bought, and edit.',
  ...
  tipInsightsTitle: 'Insights & spending',
  tipInsightsBody: 'The Insights tab shows how much you spent this month and on what, a month-end projection, and price comparison across chains.',
};
