export type TranslationKeys =
  ...
  | 'priceHelpTitle'
  | 'priceHelpIntro'
  | 'priceHelpBranchTitle'
  | 'priceHelpBranchDesc'
  | 'priceHelpMatchTitle'
  | 'priceHelpMatchDesc'
  | 'priceHelpVerifiedTitle'
  | 'priceHelpVerifiedDesc'
  | 'savingsHeroLabel'
  ...
  | 'useNearestBranch'
  | 'branchChosenByYou'
  | 'branchHasNoPriceData'
  | 'branchPricesVerified'
  | 'staleChainData'
  | 'lowConfidenceMatch'
  | 'splitSavingsHint'
  | 'matchPickerTitle'
  | 'matchPickerSubtitle'
  | 'matchPickerSearchPlaceholder'
  | 'matchPickerNoResults'
  | 'matchPickerInChains'
  | 'matchPickerFrom'
  | 'matchPickerNoneOfThese'
  | 'matchPickerReset'
  | 'matchPickerSaveFailed'
  | 'matchFixAction'
  | 'matchNotRightAction'
  | 'matchChosenByYou'
  | 'matchExcludedByYou'
  ...
  | 'noAnalysisThisTime'
  | 'estimatedBasketCost'
  | 'itemsIdentifiedOfTotal'
  | 'priceComparisonShort'
  | 'tellMeMoreAboutList'
  // רשימות קבועות
  | 'savedLists'
  | 'saveAsSavedList'
  ...
  | 'savedListsChooserApplyTitle'
  | 'savedListsChooserApplyDesc'
  | 'savedListsChooserCreateTitle'
  | 'savedListsChooserCreateDesc'
  | 'savedListsChooserCreateDisabledDesc'
  ...
  | 'tipProductNoteTitle'
  | 'tipProductNoteBody'
  | 'tipProductReorderTitle'
  | 'tipProductReorderBody'
  | 'tipListReorderTitle'
  | 'tipListReorderBody'
  | 'tipAiAssistantTitle'
  | 'tipAiAssistantBody'
  | 'tipPriceComparisonTitle'
  | 'tipPriceComparisonBody'
  | 'tipShareWhatsappTitle'
  | 'tipShareWhatsappBody'
  | 'tipSharePdfTitle'
  | 'tipSharePdfBody'
  | 'tipSavedListsTitle'
  | 'tipSavedListsBody'
  ...
  | 'subscriptionCancelDesc'
  | 'subscriptionCancelled'
  | 'subscriptionFreeLimits'
