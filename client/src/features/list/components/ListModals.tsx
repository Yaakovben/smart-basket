  ...
  return (
    <>
      ...
      <Box sx={modalContainerSx} role="dialog" aria-labelledby="invite-title">
        ...
        <Box sx={{ bgcolor: 'rgba(20, 184, 166, 0.04)', borderRadius: '12px', border: '1.5px solid', borderColor: 'rgba(20, 184, 166, 0.5)', mb: 2.5, overflow: 'hidden' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: '14px 18px', borderBottom: '1.5px solid', borderColor: 'rgba(20, 184, 166, 0.5)' }}>
  ...
  return (
    <>
      ...
      <Box sx={modalContainerSx} role="dialog" aria-labelledby="share-title">
        ...
        <Box sx={{ bgcolor: 'rgba(20, 184, 166, 0.04)', borderRadius: '12px', border: '1.5px solid', borderColor: 'rgba(20, 184, 166, 0.5)', mb: 2.5, overflow: 'hidden' }}>
          <Box sx={{ p: '14px 18px', borderBottom: '1.5px solid', borderColor: 'rgba(20, 184, 166, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
