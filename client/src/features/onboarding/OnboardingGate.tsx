...
const slides: Slide[] = [
  {
    ...
    features: [
      'זיהוי קטגוריה אוטומטי בעת ההקלדה',
      'החלקה צדדית = ערוך / סמן / מחק',
      'מותאם למובייל - מהיר וזריז',
    ],
  },
  {
    key: 'group',
    ...
    features: [
      'מי הוסיף, מי קנה, מתי - הכל ברור',
      'התראות חכמות רק כשרלוונטי',
      'הזמנת חברים בקוד או QR',
    ],
  },
  {
    key: 'prices',
    ...
    features: [
      'השוואת מחירים מ-9 רשתות מובילות',
      'הסניף הקרוב אליכם, ניווט בלחיצה',
