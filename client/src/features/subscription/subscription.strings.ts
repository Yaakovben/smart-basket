...
const he = {
  ...
  payPhone: 'העברה למספר',
  payReceiver: 'שם המקבל',
...
const en: SubscriptionStrings = {
  ...
  payPhone: 'Transfer to number',
  payReceiver: 'Recipient name',
...
const ru: SubscriptionStrings = {
  ...
  payPhone: 'Перевод на номер',
  payReceiver: 'Имя получателя',
