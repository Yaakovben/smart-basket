...
export const LoginErrorAlert = ({ error, clearing, onClearCache, t, fontSize }: LoginErrorAlertProps) => {
  return (
    <Box sx={{ mt: 2 }}>
      <Alert severity="warning" sx={{ borderRadius: '12px', fontSize, alignItems: 'center' }} role="alert" aria-live="assertive">
        {error}
      </Alert>
      {error === t('cacheError') && (
        <Button
