...
export const HomeComponent = memo(({
  ...
  const {
    orderedDisplay, reorderMode, dragIndex, pendingIndex, dragOffsetY, dragFixedTop, dragContainerLeft, dragContainerWidth, getRowShift, rowRefs,
  ...
  return (
    ...
    <Box sx={{ height: { xs: 'var(--app-height, 100dvh)', sm: '100vh' }, display: 'flex', flexDirection: 'column', bgcolor: 'background.default', maxWidth: { xs: '100%', sm: 500, md: 600 }, mx: 'auto', position: 'relative', overflow: 'hidden' }}>
      ...
      <HomeListContent
        ...
        dragContainerLeft={dragContainerLeft}
        dragContainerWidth={dragContainerWidth}
