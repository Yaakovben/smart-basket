    ...
    <>
      {showHint && (
        <Box
          sx={{
            ...
            border: '1px solid', borderColor: isDark ? 'rgba(37,99,235,0.35)' : 'rgba(37,99,235,0.2)',
      ...
      <Box
        ...
        sx={{
          ...
          zIndex: 1090,
          width: 48, height: 48,
          // צורת בועת טקסט - כל הפינות עגולות חוץ מהתחתונה-שמאלית (זנב
          // הבועה), שמצביעה כלפי חוץ לכיוון פינת המסך שבה הכפתור יושב.
          ...
          boxShadow: '0 8px 22px rgba(37,99,235,0.45), 0 3px 8px rgba(0,0,0,0.18)',
