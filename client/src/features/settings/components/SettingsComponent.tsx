      ...
      <Box sx={{ flex: 1, overflowY: 'auto', p: { xs: 2, sm: 2.5 }, pb: 'calc(24px + env(safe-area-inset-bottom))', WebkitOverflowScrolling: 'touch' }}>
        ...
        <Paper sx={{ borderRadius: '16px', overflow: 'hidden' }}>
          ...
          <Box sx={{ ...settingRowSx, borderBottom: 'none' }} onClick={() => setShowLanguage(true)}>
            ...
            <Typography sx={{ color: 'text.secondary', fontSize: 14 }}>{currentLanguage?.name}</Typography>
      ...
      {showAbout && (
        <Modal title={t('about')} onClose={() => setShowAbout(false)}>
          <Box sx={{ textAlign: 'center', py: 2 }}>
            ...
            <Typography sx={{ fontSize: 24, fontWeight: 700, color: 'text.primary', mb: 0.5 }}>
              {t('appName')}
            </Typography>
            <Typography sx={{ fontSize: 14, color: 'text.secondary', mb: 3 }}>
              {t('version')} 1.0.0
            </Typography>
            <Typography sx={{ fontSize: 15, color: 'text.secondary', mb: 3, px: 2 }}>
              {t('aboutDescription')}
            </Typography>
      ...
      {showHelp && (
        <Modal title={t('helpSupport')} onClose={() => setShowHelp(false)}>
          <Box sx={{ textAlign: 'center', py: 2 }}>
            ...
            <Typography sx={{ fontSize: 18, fontWeight: 600, color: 'text.primary', mb: 1 }}>
              {t('contactUs')}
            </Typography>
            <Typography sx={{ fontSize: 14, color: 'text.secondary', mb: 3, px: 2 }}>
              {t('helpDescription')}
            </Typography>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
              <Button
                fullWidth
                onClick={() => window.open('mailto:support@smartbasket.app')}
                sx={{
                  justifyContent: 'flex-start',
                  p: 2,
                  borderRadius: '12px',
              ...
              >
                <Box sx={{ width: 44, height: 44, borderRadius: '12px', bgcolor: '#FEF3C7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>
                  📧
                </Box>
                <Box sx={{ flex: 1, textAlign: settings.language === 'he' ? 'right' : 'left' }}>
              ...
              <Button
                fullWidth
                onClick={() => window.open('https://wa.me/972500000000')}
                sx={{
                  justifyContent: 'flex-start',
                  p: 2,
                  borderRadius: '12px',
