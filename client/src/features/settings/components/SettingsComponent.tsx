        ...
        <Modal title={t('helpSupport')} onClose={() => setShowHelp(false)}>
          <Box sx={{ textAlign: 'center', py: 2 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
              ...
              <Button component="a" href="https://wa.me/972500000000" target="_blank" rel="noopener noreferrer" fullWidth sx={{ justifyContent: 'flex-start', p: 2, borderRadius: '12px', bgcolor: '#25D366', color: 'white', textTransform: 'none', gap: 2, '&:hover': { bgcolor: '#1ebe5a' }, textDecoration: 'none' }}>
