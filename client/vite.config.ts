...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.svg', 'apple-touch-icon.svg', 'apple-touch-icon.png', 'icon-192x192.png', 'icon-512x512.png', 'icon-maskable-192x192.png', 'icon-maskable-512x512.png'],
      devOptions: {
        enabled: false
      },
      injectManifest: {
